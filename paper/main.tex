...
% decision. Current candidate (2026-08-28):
%   "Block Size or Scale Format? A Backward-Error Decomposition of
%    MXFP4 and NVFP4"
%
% Changed 2026-08-28 from "Which Design Choice Explains NVFP4's Edge over
...
% Other candidates considered: "Which Design Choice Moves Backward Error
% More: Block Size or Scale Format? An MXFP4/NVFP4 Decomposition";
% "Separating Block Size from Scale Format in the MXFP4/NVFP4
...
\begin{abstract}
  ...
  accumulator rounding, within a backward-error framework in the tradition of
  classical rounding-error analysis but adapted where that analysis no longer
  applies under exact accumulation. Block size and
