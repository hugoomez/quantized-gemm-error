...
that at 1000--5000 trials excludes $-0.5$ even when the point estimate misses it
by a few thousandths. By magnitude instead ($|\mathrm{slope} - (-0.5)| > 0.02$), 63 of 128
...
With the backward-error margin narrowing sharply at $\nu = 1$, the clean ``scale
format dominates'' reading holds cleanly except at the single heaviest tail
examined.
